...
void showrule()
{
    ...
    outtextxy(320,50,"W/w:move upwards");
    outtextxy(320,125,"S/s:move downwards");
    outtextxy(320,200,"A/a:turn left");
    outtextxy(320,275,"D/d:turn right");
    outtextxy(320,350,"space:pause");
